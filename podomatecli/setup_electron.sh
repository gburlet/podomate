...
cp podomate.icns Electron.app/Contents/Resources
rm Electron.app/Contents/Resources/electron.icns
plutil -replace CFBundleDisplayName -string Podomate Electron.app/Contents/Info.plist
plutil -replace CFBundleIconFile -string podomate.icns Electron.app/Contents/Info.plist
plutil -replace CFBundleIdentifier -string io.podomate Electron.app/Contents/Info.plist
plutil -replace CFBundleName -string Podomate Electron.app/Contents/Info.plist
