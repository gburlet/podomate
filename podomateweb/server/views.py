...
class ClientVersion(APIView):
    ...
    Test GET:
        curl "http://localhost:8001/api/version?sku=podomate-desktop&version=0.1.21"
    """
...
class Update(APIView):
    ...
    Test GET:
        curl "http://localhost:8001/api/update?sku=podomate-desktop"
    """
...
class Activate(APIView):
    ...
    def post(self, request):
        ...
        private_key_path = os.path.join(os.path.dirname(__file__), "podomate_private.pem")
